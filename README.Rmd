...
surveywts ships with a harmonized online panel (`ns_wave1_ipw`) and a GSS
2024 reference design (`gss_ipw_ref`) to illustrate the workflow.
...
```{r calibrate-to-survey, eval=FALSE}
