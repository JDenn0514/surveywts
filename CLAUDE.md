...
|----------------------------------------------|----------|-------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Phase 0 — Calibration Core                   | `v0.1.0` | ✅ Complete | `survey_nonprob`, [`calibrate()`](https://jdenn0514.github.io/surveywts/reference/calibrate.md), [`rake()`](https://jdenn0514.github.io/surveywts/reference/rake.md), [`poststratify()`](https://jdenn0514.github.io/surveywts/reference/poststratify.md), basic diagnostics |
...
**Next action:** Begin Phase 1. Start with `/spec-workflow` to draft the
