...
# create_group_jackknife_weights() warns when repweights already populated
    ...
    Output
      ...
      #   Step 1 [2026-06-03]: ipw [~age_group + sex, logit, n_ref=500, N_hat=501] 
      #   Step 2 [2026-06-03]: group_jackknife_weights 
      #   Step 3 [2026-06-03]: group_jackknife_weights 
...
# create_group_jackknife_weights() warns when > 10% of replicates fail
    ...
    Output
      ...
      # IDs: ~1 | Strata: NULL | Weights: ipw_weight 
      # Weighting history: 2 steps 
      #   Step 1 [2026-06-03]: ipw [~age_group, logit, n_ref=6, N_hat=600] 
      #   Step 2 [2026-06-03]: group_jackknife_weights 
