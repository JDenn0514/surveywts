# print(survey_replicate) bootstrap snapshot
    ...
    Output
      ...
      Weighting history:
        #   Step 1 [2026-05-11]: replicate_creation (method = "bootstrap", type = "Rao-Wu-Yue-Beaumont", replicates = 50)
...
# print(survey_replicate) JKn stratified delete-1 snapshot
    ...
    Output
      ...
      Weighting history:
        #   Step 1 [2026-05-11]: replicate_creation (method = "jackknife", type = "JKn")
...
# print(survey_replicate) BRR snapshot
    ...
    Output
      ...
      Weighting history:
        #   Step 1 [2026-05-11]: replicate_creation (method = "brr")
...
# print(survey_replicate) two-entry history snapshot
    ...
    Output
      ...
      Weighting history:
        #   Step 1 [2026-05-11]: replicate_creation (method = "bootstrap", type = "Rao-Wu-Yue-Beaumont", replicates = 20)
