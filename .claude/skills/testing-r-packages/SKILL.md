...
See [references/patterns.md](references/patterns.md) for examples: error classes,
temporary files, modified options, multiple cases, custom expectations, file system
discipline, and testthat 3 modernizations.
...
- **[references/patterns.md](references/patterns.md)** - Common patterns, file system discipline, testthat 3 modernizations
