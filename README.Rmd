...
reference surveys (`gss_2024`, `npors_2025_clean`, `cps_2023`) to
illustrate the workflow. Survey designs are constructed from the tibbles
with `surveycore::as_survey()` or `surveycore::as_survey_nonprob()`.
...
final variance estimates. Both designs must carry replicate weights. Here the
