...
- [ ] PR 1: `feature/calibration-nr-engine` — Shared NR engine, calfun objects, `.validate_bounds()`, `.validate_unit_scale()`, migrate `.calibrate_engine()`, update `.build_calibration_provenance()`
