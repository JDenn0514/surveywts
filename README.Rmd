...
population totals, adjusting for nonresponse, and diagnosing weight quality —
all with full weighting history tracking for reproducible survey analysis.
...
surveywts is part of the [surveyverse](https://github.com/JDenn0514) ecosystem.
It provides three calibration methods, nonresponse adjustment, and weight
diagnostics — all using tidy, formula-free syntax.
...
Every function tracks the full weighting history so you can audit exactly what
